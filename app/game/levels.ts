...
export const LEVELS: Level[] = [
  ...
  { name: "Chain Letter", world: "VELVET DRAIN", tint: "#087CFF", time: 66,
  ...
  { name:"Blue Pressure",world:"VELVET DRAIN",tint:"#087CFF",time:70,
  ...
  { name:"Room 108",world:"HEARTBREAK HOTEL",tint:"#FF2A9D",time:72,
  ...
  { name:"Mirror Teeth",world:"HEARTBREAK HOTEL",tint:"#FF2A9D",time:74,
  ...
  { name:"Last Lift",world:"HEARTBREAK HOTEL",tint:"#FF2A9D",time:76,
  ...
  { name:"Poison Moon",world:"JADE GARDEN",tint:"#20C98B",time:78,
  ...
  { name:"Black Roses",world:"JADE GARDEN",tint:"#20C98B",time:78,
  ...
  { name:"Serpent Glass",world:"CRIMSON CHAPEL",tint:"#C4133D",time:82,
  ...
  { name:"Thirteen Candles",world:"CRIMSON CHAPEL",tint:"#C4133D",time:82,
  ...
  { name:"Event Horizon",world:"THE BLACK BUBBLE",tint:"#756CFF",time:86,
  ...
  { name:"The Widow Unveiled",world:"THE BLACK BUBBLE",tint:"#C4133D",time:108,boss:true,
